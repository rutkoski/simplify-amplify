...
class Amplify_Controller extends Simplify_Controller
{
  ...
  public function getLayoutsPath()
  {
    ...
    $path[] = s::config()->resolveReferences("{modules:amp:dir}templates/{theme}/layouts/");
    $path[] = s::config()->resolveReferences("{modules:amp:dir}templates/layouts/");
    return $path;
  }
  ...
  {
    $path = (array)parent::getTemplatesPath();
    $path[] = s::config()->resolveReferences("{modules:amp:dir}templates/{theme}/{$this->getPath()}");
    $path[] = s::config()->resolveReferences("{modules:amp:dir}templates/{$this->getPath()}");
    return $path;
  }
