...
<div class="navbar navbar-fixed-top">
  <div class="navbar-inner">
    <div class="container-fluid">
      <a class="brand" href="<?= Simplify_URL::make('route://admin') ?>">
        <?= Options::value('site_name') ?>
        <small><?= Options::value('site_tagline') ?></small>
      </a>

      <?= $this->top_menu->show($menu) ?>

      <ul class="nav pull-right">
        <?php $user = Account::getUser() ?>
        <li><a href="<?= Simplify_URL::make(s::router()->build('admin_account')) ?>"><i class="icon-user"></i> <?= $user['user_email'] ?></a></li>
        <li><a href="<?= Simplify_URL::make(s::router()->build('home')) ?>"><i class="icon-external-link"></i> Ir para o site</a></li>
        <li><a href="<?= Simplify_URL::make(s::router()->build('admin', array('action' => 'logout'))) ?>"><i class="icon-signout"></i> Logout</a></li>
      </ul>
    </div>
  </div>
</div>
