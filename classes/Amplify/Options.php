...
class Options
{
  ...
  {
    \Simplify::db()->delete(\Simplify::config()->get('amp:tables:options'), 'option_name = ?')->execute($name);
  ...
  public static function exists($name)
  {
    ...
    $exists = isset(self::$options[$name]) ||
       self::repository()->findCount(array('where' => 'option_name = ?', 'data' => array($name)));
